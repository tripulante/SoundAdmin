/**
 * @mainpage OggLoader for OpenAL
 * @brief Librería que se encarga de cargar un archivo Ogg y convertirlo en un buffer OpenAL
 * Basado en un artículo previo desarrollado en www.gamedev.net
